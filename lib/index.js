...
function sendScoreToStorage(leaderboard) {
  ...
  if (sortLeader.length < 11 || userScore.score > sortLeader[10].score) {
  ...
  function displayGameover() {
    ...
    endgameDisplay.innerHTML += 
      `
        ...
        <div class="gameover-text font-gradient">GAME OVER!!! ENTER YOUR INITIALS</div>
        <input type="text" name="initials" class="initials" maxlength="3" placeholder="AAA">
